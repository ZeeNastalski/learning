...
#include "ZLSteamVRFunctionLibrary.generated.h"

/** Defines the class of tracked devices in SteamVR*/
UENUM(BlueprintType)
enum class EZLSteamVRTrackedDeviceType : uint8
{
 ...
 */
UCLASS()
class ZLSTEAMVR_API UZLSteamVRFunctionLibrary : public UBlueprintFunctionLibrary
{
...
public:
	...
	static void GetValidTrackedDeviceIds(EZLSteamVRTrackedDeviceType DeviceType, TArray<int32>& OutTrackedDeviceIds);
