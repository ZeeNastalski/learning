...
UZLSteamVRFunctionLibrary::UZLSteamVRFunctionLibrary(const FObjectInitializer& ObjectInitializer)
...
void UZLSteamVRFunctionLibrary::GetValidTrackedDeviceIds(EZLSteamVRTrackedDeviceType DeviceType, TArray<int32>& OutTrackedDeviceIds)
{
#if STEAMVR_SUPPORTED_PLATFORMS
	...
	switch (DeviceType)
	{
	case EZLSteamVRTrackedDeviceType::Controller:
		XRDeviceType = EXRTrackedDeviceType::Controller;
		break;
	case EZLSteamVRTrackedDeviceType::TrackingReference:
		XRDeviceType = EXRTrackedDeviceType::TrackingReference;
		break;
	case EZLSteamVRTrackedDeviceType::Other:
		XRDeviceType = EXRTrackedDeviceType::Other;
		break;
	case EZLSteamVRTrackedDeviceType::Invalid:
...
bool UZLSteamVRFunctionLibrary::GetTrackedDevicePositionAndOrientation(int32 DeviceId, FVector& OutPosition, FRotator& OutOrientation)
{
	bool RetVal = false;
...
bool UZLSteamVRFunctionLibrary::GetHandPositionAndOrientation(int32 ControllerIndex, EControllerHand Hand, FVector& OutPosition, FRotator& OutOrientation)
{
	bool RetVal = false;
