...
//ZEROLATENCYVR
DECLARE_LOG_CATEGORY_EXTERN(LogZLSteamVR, Log, All);
//~ZEROLATENCYVR
...
public:
	...
	{
		return FModuleManager::LoadModuleChecked< ISteamVRPlugin >( "ZLSteamVR" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "ZLSteamVR" );
	}
