...
#include "../../ZLSteamVR/Private/SteamVRHMD.h"
#include "ZLSteamVRControllerLibrary.h" // for ESteamVRTouchDPadMapping
...
public:
		  ...
		  SteamVRPlugin(nullptr)
	{
		...
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Left_HandGrip, LOCTEXT("SteamVR_Knuckles_Left_HandGrip", "SteamVR Knuckles (L) Hand Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Left_IndexGrip, LOCTEXT("SteamVR_Knuckles_Left_IndexGrip", "SteamVR Knuckles (L) Index Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Left_MiddleGrip, LOCTEXT("SteamVR_Knuckles_Left_MiddleGrip", "SteamVR Knuckles (L) Middle Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Left_RingGrip, LOCTEXT("SteamVR_Knuckles_Left_RingGrip", "SteamVR Knuckles (L) Ring Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Left_PinkyGrip, LOCTEXT("SteamVR_Knuckles_Left_PinkyGrip", "SteamVR Knuckles (L) Pinky Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));

		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Right_HandGrip, LOCTEXT("SteamVR_Knuckles_Right_HandGrip", "SteamVR Knuckles (R) Hand Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Right_IndexGrip, LOCTEXT("SteamVR_Knuckles_Right_IndexGrip", "SteamVR Knuckles (R) Index Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Right_MiddleGrip, LOCTEXT("SteamVR_Knuckles_Right_MiddleGrip", "SteamVR Knuckles (R) Middle Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Right_RingGrip, LOCTEXT("SteamVR_Knuckles_Right_RingGrip", "SteamVR Knuckles (R) Ring Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));
		ConditionalAddKey(FKeyDetails(SteamVRControllerKeys::SteamVR_Knuckles_Right_PinkyGrip, LOCTEXT("SteamVR_Knuckles_Right_PinkyGrip", "SteamVR Knuckles (R) Pinky Grip CapSense"), FKeyDetails::GamepadKey | FKeyDetails::FloatAxis));

		IModularFeatures::Get().RegisterModularFeature(GetModularFeatureName(), this);
#endif // STEAMVRCONTROLLER_SUPPORTED_PLATFORMS
	}

	void ConditionalAddKey(FKeyDetails KeyToAdd)
	{
		TArray<FKey> AllKeys;
		EKeys::GetAllKeys(AllKeys);

		// This can occur when the SteamVR plugin is loaded already
		if (AllKeys.Contains(KeyToAdd.GetKey()))
		{
			return;
		}

		EKeys::AddKey(KeyToAdd);
	}
	...
	void SetTouchDPadMapping(EZLSteamVRTouchDPadMapping NewMapping)
	{
#if STEAMVRCONTROLLER_SUPPORTED_PLATFORMS
		...
		switch (NewMapping)
		{
		case EZLSteamVRTouchDPadMapping::FaceButtons:
		...
		case EZLSteamVRTouchDPadMapping::ThumbstickDirections:
		...
		case EZLSteamVRTouchDPadMapping::Disabled:
	...
	static EZLSteamVRTouchDPadMapping DefaultDPadMapping;
private:
	...
	inline vr::IVRSystem* GetVRSystem()
	{
		...
		{
			SteamVRPlugin = &FModuleManager::LoadModuleChecked<ISteamVRPlugin>(TEXT("ZLSteamVR"));
		}
...
EZLSteamVRTouchDPadMapping FSteamVRController::DefaultDPadMapping = EZLSteamVRTouchDPadMapping::FaceButtons;
#endif // STEAMVR_SUPPORTED_PLATFORMS
/// @endcond

// defined here in this .cpp file so we have access to FSteamVRController
void UZLSteamVRControllerLibrary::SetTouchDPadMapping(EZLSteamVRTouchDPadMapping NewMapping)
{
#if STEAMVR_SUPPORTED_PLATFORMS
...
IMPLEMENT_MODULE( FSteamVRControllerPlugin, ZLSteamVRController)
